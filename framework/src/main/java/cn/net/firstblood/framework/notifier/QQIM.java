...
public class QQIM{
	...
	public static synchronized String notify(String content) {
		...
		jsonMap.put("content", "[\""+content+"\",[\"font\",{\"name\":\"宋体\",\"size\":10,\"style\":[0,0,0],\"color\":\"000000\"}]]");
	...
	public static String receive(){
		...
		HttpPost post = HttpClientUtil.getPost("http://d.web2.qq.com/channel/poll2",params);
		post.addHeader(new BasicHeader("Cookie",COOKIE));
		post.addHeader(new BasicHeader("Referer",REFERER));
		try {
